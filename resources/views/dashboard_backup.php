...
@section('content')
{{ json_encode($thisYearImmunizations) }}
    <!-- Begin Page Content -->
                    ...
                    <div class="card-body pl-5">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-light text-uppercase mb-1">
                                    Doses Completed</div>
                                <div class="text-light h3 mb-0 font-weight-bold text-gray-800">#</div>
                            </div>
                            <div class="col-auto pr-5">
                                <i class="fas fa-calendar-check fa-2x text-gray-300 border rounded bg-dark p-2"></i>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="chart-area">
                                ...
                                <script>
                                    ...
                                    var immunizations = {{ Js::from($thisYearImmunizations) }};
    ...
    <!--Export Modal -->
    <div class="modal fade" id="exportImmunizationModal" tabindex="-1" role="dialog"
