...
class PregnantController extends Controller
{
    ...
    public function index(Request $request)
    {
        $vaccines = Vaccine::where([
            ['vaccine_category_id', '3'],
            ['status', 'Available'],
            ])->get();

        $immunizations = Immunization::where('immunization_category_id', '3')->with('immunization_category')->orderBy('date_recorded', 'DESC')->get();
        
        return view('pregnant_immunization.index', compact('vaccines', 'immunizations'));
    }
    ...
    public function store(StoreImmunizationRequest $request)
    {
        ...
        return redirect()->route('pregnant_immunizations.index')->with('success', 'Immunization Added Successfully!');
    }
    ...
    public function update(UpdateImmunizationRequest $request, $id)
    {
        ...
        return redirect()->route('pregnant_immunizations.index')->with('success', 'Immunization Edited Successfuly!');
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return redirect()->route('pregnant_immunizations.index')->with('success', 'Immunization Successfully Moved to Archive');
    }
    ...
    public function administered(Request $request){
        ...
        return redirect()->route('pregnant_immunizations.index')->with('success','Doses Successfully Administered');
    }
    ...
    public function multiAction(Request $request){
        ...
        if(strval($request->actions) === "Archive"){
           ...
           return redirect()->route('pregnant_immunizations.index')->with('success', 'Immunizations Successfully Moved to Archive');
